...
public final class CBBase64 {
    ...
    public static String encode(String in) {
        return encode(in, CBDefaultConfig.CHARSET);
    }
    ...
    public static String encode(String in, String charset) {
        try {
            return encode(in.getBytes(charset));
    ...
    public static String decode(String in) throws IOException {
        return decode(in, CBDefaultConfig.CHARSET);
    }
    ...
    static private final int BASE_LENGTH = 255;
    ...
    private static boolean isWhiteSpace(char ch) {
        return (ch == 0x20 || ch == 0xd || ch == 0xa || ch == 0x9);
    }
    ...
    private static boolean isBase64(char ch) {
        return (isWhiteSpace(ch) || isPad(ch) || isData(ch));
    }
     ...
     * @return Array contain decoded data.
     */
